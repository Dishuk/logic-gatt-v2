...
import { openProjectFile, pickProjectDirectory, resolveProjectPath, writeProjectFile } from './project-store'
...
// ble-uart's `serialport` dependency stays unbundled; see electrobun.config.ts.
